		...
		var treeUnwrap = F2(
			function (_p2, accu$) {
				...
				return A2(
					f,
					_p3._0,
					A3(_elm_lang$core$List$foldr, treeUnwrap, accu$, _p3._1));
			});
		return A2(
			f,
			_p1._0,
			A3(_elm_lang$core$List$foldr, treeUnwrap, accu, _p1._1));
	});
...
var _tomjkidd$elm_multiway_tree_zipper$MultiwayTree$children = function (_p8) {
	var _p9 = _p8;
	return _p9._1;
};
var _tomjkidd$elm_multiway_tree_zipper$MultiwayTree$datum = function (_p10) {
	var _p11 = _p10;
	return _p11._0;
};
...
var _tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$updateChildren = F2(
	function (newChildren, _p2) {
		var _p3 = _p2;
		return {
			ctor: '_Tuple2',
			_0: A2(_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree, _p3._0._0, newChildren),
			_1: _p3._1
		};
	});
...
var _tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$goUp = function (_p7) {
	var _p8 = _p7;
	var _p9 = _p8._1;
	if (_p9.ctor === '::') {
		return _elm_lang$core$Maybe$Just(
...
var _tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$goToRoot = function (_p10) {
	var _p11 = _p10;
	var _p14 = _p11._0;
	var _p13 = _p11._1;
	var _p12 = _p13;
...
var _tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$splitOnIndex = F2(
	function (n, xs) {
		...
		if (_p15.ctor === 'Nothing') {
			...
			return _elm_lang$core$Maybe$Just(
				{ctor: '_Tuple3', _0: before, _1: _p15._0, _2: after});
		}
	});
...
var _tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$goToChild = F2(
	function (n, _p16) {
		var _p17 = _p16;
		var maybeSplit = A2(_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$splitOnIndex, n, _p17._0._1);
		var _p18 = maybeSplit;
			...
			return _elm_lang$core$Maybe$Just(
				{
					...
					_1: A2(
						_elm_lang$core$List_ops['::'],
						A3(_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$Context, _p17._0._0, _p18._0._0, _p18._0._2),
						_p17._1)
				});
		}
	});
var _tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$goRight = function (_p19) {
	var _p20 = _p19;
	var _p21 = _p20._1;
	if (_p21.ctor === '::') {
		var _p22 = _p21._0._2;
		if (_p22.ctor === '[]') {
			...
			return _elm_lang$core$Maybe$Just(
				{
					ctor: '_Tuple2',
					_0: A2(_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree, _p22._0._0, _p22._0._1),
					_1: A2(
						_elm_lang$core$List_ops['::'],
						A3(
...
var _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$deepTree = A2(
	_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree,
	'a',
	_elm_lang$core$Native_List.fromArray(
		[
...
var _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$multiChildTree = A2(
	_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree,
	'a',
	_elm_lang$core$Native_List.fromArray(
		[
...
var _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$singleChildTree = A2(
	_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree,
	'a',
	_elm_lang$core$Native_List.fromArray(
		[
...
var _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$noChildRecord = A2(
	_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree,
	{selected: false, expanded: false},
	_elm_lang$core$Native_List.fromArray(
		[]));
var _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$noChildTree = A2(
	_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree,
	'a',
	_elm_lang$core$Native_List.fromArray(
		[]));
var _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$interestingTree = A2(
	_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$Tree,
	'a',
	_elm_lang$core$Native_List.fromArray(
		[
...
var _tomjkidd$elm_multiway_tree_zipper$Test_FlattenTests$tests = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			'Flatten multiChildTree',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Native_List.fromArray(
					['a', 'b', 'c', 'd']),
				_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$flatten(_tomjkidd$elm_multiway_tree_zipper$Test_SampleData$multiChildTree))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Flatten deepTree',
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					['a', 'b', 'c', 'd']),
				_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$flatten(_tomjkidd$elm_multiway_tree_zipper$Test_SampleData$deepTree))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Flatten interestingTree',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Native_List.fromArray(
					['a', 'b', 'e', 'k', 'c', 'f', 'g', 'd', 'h', 'i', 'j']),
				_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$flatten(_tomjkidd$elm_multiway_tree_zipper$Test_SampleData$interestingTree)))
		]));

var _tomjkidd$elm_multiway_tree_zipper$Test_FoldTests$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Fold',
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Foldl interestingTree into List',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_tomjkidd$elm_multiway_tree_zipper$MultiwayTree$flatten(_tomjkidd$elm_multiway_tree_zipper$Test_SampleData$interestingTree),
				_elm_lang$core$List$reverse(
					A3(
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						_tomjkidd$elm_multiway_tree_zipper$Test_SampleData$interestingTree))))
		]));

var _tomjkidd$elm_multiway_tree_zipper$Test_NavigationTests_ops = _tomjkidd$elm_multiway_tree_zipper$Test_NavigationTests_ops || {};
_tomjkidd$elm_multiway_tree_zipper$Test_NavigationTests_ops['&>'] = _elm_lang$core$Maybe$andThen;
var _tomjkidd$elm_multiway_tree_zipper$Test_NavigationTests$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Navigation',
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				...
				A2(
					_tomjkidd$elm_multiway_tree_zipper$Test_NavigationTests_ops['&>'],
					_elm_lang$core$Maybe$Just(
						{
							ctor: '_Tuple2',
							_0: _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$singleChildTree,
							_1: _elm_lang$core$Native_List.fromArray(
								[])
						}),
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Maybe$Just(
						{
							ctor: '_Tuple2',
							_0: _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$multiChildTree,
							_1: _elm_lang$core$Native_List.fromArray(
								[])
						}),
					_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$goToChild(1)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Navigate to a child (deep)',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Maybe$Just(
					{
					...
					A2(
						...
						A2(
							...
							_elm_lang$core$Maybe$Just(
								{
									ctor: '_Tuple2',
									_0: _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$deepTree,
									_1: _elm_lang$core$Native_List.fromArray(
										[])
								}),
							_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$goToChild(0)),
			...
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Navigate up (single level with many children)',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Maybe$Just(
					{
			...
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Navigate beyond the tree (only child)',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
			...
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Navigate beyond the tree (up past root)',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Maybe$Nothing,
				A2(
			...
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Navigate to right sibling on no child tree does not work',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Maybe$Nothing,
				A2(
					...
					_elm_lang$core$Maybe$Just(
						{
							ctor: '_Tuple2',
							_0: _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$noChildTree,
							_1: _elm_lang$core$Native_List.fromArray(
								[])
						}),
					_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$goRight))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				...
				A2(
					...
					_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$goToChild(2)),
				A2(
					_tomjkidd$elm_multiway_tree_zipper$Test_NavigationTests_ops['&>'],
					A2(
						_tomjkidd$elm_multiway_tree_zipper$Test_NavigationTests_ops['&>'],
			...
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Navigate to right child when there are no siblings left return Nothing',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Maybe$Nothing,
				A2(
...
var _tomjkidd$elm_multiway_tree_zipper$Test_UpdateTests_ops = _tomjkidd$elm_multiway_tree_zipper$Test_UpdateTests_ops || {};
_tomjkidd$elm_multiway_tree_zipper$Test_UpdateTests_ops['&>'] = _elm_lang$core$Maybe$andThen;
var _tomjkidd$elm_multiway_tree_zipper$Test_UpdateTests$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Update',
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				...
				A2(
					_tomjkidd$elm_multiway_tree_zipper$Test_UpdateTests_ops['&>'],
					_elm_lang$core$Maybe$Just(
						{
							ctor: '_Tuple2',
							_0: _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$noChildTree,
					...
					_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$updateDatum(
						function (a) {
							return A2(_elm_lang$core$Basics_ops['++'], a, 'x');
						})))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Update datum (record)',
			A2(
				...
				A2(
					...
					_elm_lang$core$Maybe$Just(
						{
							ctor: '_Tuple2',
							_0: _tomjkidd$elm_multiway_tree_zipper$Test_SampleData$noChildRecord,
							_1: _elm_lang$core$Native_List.fromArray(
								[])
						}),
					_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$updateDatum(
			...
			A2(
				...
				A2(
					...
					_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$replaceDatum('x')))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Replace datum (record)',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Maybe$Just(
					{
				...
				A2(
					...
					_tomjkidd$elm_multiway_tree_zipper$MultiwayTreeZipper$replaceDatum(
						{selected: true, expanded: true}))))
		]));

var _tomjkidd$elm_multiway_tree_zipper$Test_MultiwayTreeZipper$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'MultiwayTreeZipper',
	_elm_lang$core$Native_List.fromArray(
		[_tomjkidd$elm_multiway_tree_zipper$Test_NavigationTests$tests, _tomjkidd$elm_multiway_tree_zipper$Test_UpdateTests$tests, _tomjkidd$elm_multiway_tree_zipper$Test_FlattenTests$tests, _tomjkidd$elm_multiway_tree_zipper$Test_FoldTests$tests]));
var _tomjkidd$elm_multiway_tree_zipper$Test_MultiwayTreeZipper_ops = _tomjkidd$elm_multiway_tree_zipper$Test_MultiwayTreeZipper_ops || {};
_tomjkidd$elm_multiway_tree_zipper$Test_MultiwayTreeZipper_ops['&>'] = _elm_lang$core$Maybe$andThen;

var _tomjkidd$elm_multiway_tree_zipper$Tests$all = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Elm MultiwayTreeZipper Tests',
	_elm_lang$core$Native_List.fromArray(
		[_tomjkidd$elm_multiway_tree_zipper$Test_MultiwayTreeZipper$tests]));
var _tomjkidd$elm_multiway_tree_zipper$Tests$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_tomjkidd$elm_multiway_tree_zipper$Tests$all)
};

var Elm = {};
Elm['Tests'] = Elm['Tests'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Tests'], 'Tests', typeof _tomjkidd$elm_multiway_tree_zipper$Tests$main === 'undefined' ? null : _tomjkidd$elm_multiway_tree_zipper$Tests$main);
